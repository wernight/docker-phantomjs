# Supported tags and respective `Dockerfile` links
  ...
  * [`alpine`](https://github.com/wernight/docker-phantomjs/blob/master/alpine/Dockerfile) built from the [latest PhantomJS snapshot](https://github.com/ariya/phantomjs/commits/master) but based on Alpine Linux [![](https://images.microbadger.com/badges/image/wernight/phantomjs:alpine.svg)](http://microbadger.com/images/wernight/phantomjs "Get your own image badge on microbadger.com")
